...
export const FACTORY_ADDRESS_MAP = {
  ...
  [ChainId.PAXEER]: '0x8C63e50A2CdF7AA32E72CC66F647695c193970BC',
...
export const INIT_CODE_HASH_MAP = {
  ...
  [ChainId.PAXEER]: INIT_CODE_HASH_ETH,
...
export const WNATIVE = {
  ...
  [ChainId.PAXEER]: WETH9[ChainId.PAXEER],
...
export const NATIVE = {
  ...
  [ChainId.PAXEER]: { name: 'PAXEER', symbol: 'PAX', decimals: 18 },
} satisfies Record<
  ChainId,
  {
    name: string
