          ...
          props.pendingRewardData.map((item, index) => {
            return (
              <CardBox key={item.name}>
                {index === 0 && (
                  <PoolIcon>
                    <img src="https://yantra-assets.netlify.app/images/symbol/xyantra.png" alt="eth" />
                  </PoolIcon>
                )}
                {index === 1 && (
                  <PoolIcon>
                    <img src="https://yantra-assets.netlify.app/images/symbol/eth.png" alt="eth" />
                    <img
                      src="https://yantra-assets.netlify.app/images/symbol/usdt.png"
                      style={{ marginLeft: -4 }}
                      alt="usdc"
                    />
                  </PoolIcon>
