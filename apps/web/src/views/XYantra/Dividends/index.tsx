...
const Dividends = () => {
  ...
  const dashboardData = useDashboardData(xYantraPrice, ethUsdtLpPrice)
  ...
  } = useDistributionData(xYantraPrice, ethUsdtLpPrice)
  const {
    pendingRewardData,
    totalPendingRewardInUSD,
    refetchContracts: refetchPendingRewardData,
  } = usePendingRewardData(xYantraPrice, ethUsdtLpPrice)
    ...
    <Page>
      ...
      >
        <EPageHeader pageName="Dividends">
          <Instruction>
            Allocate xYANTRA here to earn a share of protocol earnings in the form of real yield.
          </Instruction>
        </EPageHeader>
        ...
        <Flex marginTop={36} flexWrap="wrap" style={{ gap: 12 }} justifyContent="center">
          <Flex style={{ gap: 12 }} flexWrap="wrap" justifyContent="center">
            <RewardCard>
              <RewardValue>{dashboardData ? displayNumber(dashboardData.protocolAllocation) : '-'} xYANTRA</RewardValue>
