...
import { YANTRA_ADDRESS } from 'config/constants/yantra'
...
const InstructionCard = (props) => {
  const xYantraPrice = useTokenPriceBaseStableCoin(YANTRA_ADDRESS)
      ...
      <DetailBox>
        <Flex>
          <DetailCard>
            ...
            <span>${formatAmount(xYantraPrice)}/xYANTRA</span>
          </DetailCard>
          <DetailCard>
        ...
        <p style={{ color: 'gray' }}>
          ...
          accessible by whitelisted participants. In addition to PROJECTNAME's own whitelist, xYANTRA holders who
        ...
        <p style={{ color: 'gray' }}>
          <p>
            1. xYANTRA allocators will receive a guaranteed share of those $600,000 allocations during the first stage
            (12h duration), with the whitelisted amount proportional to the total amount of xYANTRA allocated, capped to
            $5k/wallet.
          </p>
          <p>
        ...
        <p style={{ color: 'gray' }}>
          Since an individuals' whitelist allocation is proportional to the total amount of xYANTRA allocated to the
