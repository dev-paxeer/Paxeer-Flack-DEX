...
export const LAUNCH_LIST = [
  {
    ...
    officialSiteUrl: 'https://yantra.exchange',
    title: 'Public sale',
    logoImage: 'https://yantra-assets.netlify.app/images/symbol/yantra.png',
    tokenLogo1: 'https://yantra-assets.netlify.app/images/symbol/yantra.png',
    tokenLogo2: 'https://yantra-assets.netlify.app/images/symbol/yantra.png',
    bannerImage: 'https://yantra-assets.netlify.app/images/symbol/yantra.png',
    siteUrl: '',
    description: (
      <>
        <p>
          Developed on Blast, Yantra is an immutable, decentralized, community-driven DEX with the goal of
        ...
        <p>
          Providing "Real Yields" to all participants, Yantra hopes to establish a new benchmark as the Liquidity Hub of
          this ecosystem, being the first of its kind on Blast.
        </p>
      </>
    ),
    warning:
      'Please ensure you understand the public sale mechanics and terms before proceeding, deposited amounts CANNOT be withdrawn. The token will be sold for a fully diluted valuation (FDV) of 15M, fixing a $0.15 price per YANTRA. Your allocation will be made up of 65% YANTRA and 35% xYANTRA, its escrowed counterpart.',
    priceInfo: (
      <>
        <p>
          You can contribute with ETH in exchange for YANTRA tokens, which are to be claimed 24h after the end of the
          sale.
        </p>{' '}
        <p>The tokens you will receive will have the exact same $ value than your contribution.</p>{' '}
        <p>
          15,000 YANTRA (of a 100,000 total supply) will be allocated to the sale. The final price will therefore be
        </p>
      </>
    ),
    stageInfo: {
    ...
    claimInfo: (
      <>
        ...
        <p>
          In order to align the long-term objectives of the protocol, the sale will be distributed in 65% of YANTRA and
          35% of xYANTRA.
        </p>
      </>
    ),
