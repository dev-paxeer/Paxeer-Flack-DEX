    ...
    <Page>
      ...
      >
        ...
        <Flex marginTop={36} flexWrap="wrap" style={{ gap: 12 }} justifyContent="center">
          <Flex style={{ gap: 12 }}>
            <RewardCard>
              <RewardValue>xYANTRA balance</RewardValue>
              <RewardLabel>0 xYANTRA</RewardLabel>
            </RewardCard>
          ...
          <Flex style={{ gap: 12 }}>
            <RewardCard>
              ...
              <RewardLabel>0 YANTRA</RewardLabel>
            </RewardCard>
        ...
        <Flex marginTop={36} flexDirection="column" alignItems="center">
          ...
          <Flex style={{ gap: 4, color: '#72898c', fontSize: 15 }}>
            <span>xYANTRA</span> -<span>Rewards Distributor</span> -<span>Gauge Controller</span>
          </Flex>
        </Flex>
