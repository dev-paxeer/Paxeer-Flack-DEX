...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.PAXEER]: [USDC[ChainId.PAXEER], USDT[ChainId.PAXEER], WNATIVE[ChainId.PAXEER]],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.BLAST_TESTNET]: [[blastSepoliaTokens.usdt, blastSepoliaTokens.weth]],
  [ChainId.PAXEER]: [
    [USDC[ChainId.PAXEER], WNATIVE[ChainId.PAXEER]],
    [USDT[ChainId.PAXEER], WNATIVE[ChainId.PAXEER]],
  ],
}
