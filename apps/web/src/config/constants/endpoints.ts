...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.PAXEER]: 'https://v1-api.paxeer.app/subgraphs/name/flack/exchange-v2-positions-paxeer',
}
...
export const BLOCKS_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.PAXEER]: 'https://v1-api.paxeer.app/subgraphs/name/yantra/blocks',
}
...
export const V3_SUBGRAPH_URLS = {
  ...
  [ChainId.PAXEER]: 'https://v1-api.paxeer.app/subgraphs/name/flack/exchange-v3-paxeer',
...
export const PAXEER_PRICE_API = 'https://dex-api.paxeer.app/api/prices'
