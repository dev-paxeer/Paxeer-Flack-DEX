...
export const PANCAKE_EXTENDED = 'https://tokens.yantra.exchange/pancakeswap-extended.json'

const COINGECKO = 'https://tokens.yantra.exchange/coingecko.json'
const PANCAKE_ETH_DEFAULT = 'https://tokens.yantra.exchange/pancakeswap-eth-default.json'
const PANCAKE_ZKSYNC_DEFAULT = 'https://tokens.yantra.exchange/pancakeswap-zksync-default.json'
const PANCAKE_POLYGON_ZKEVM_DEFAULT = 'https://tokens.yantra.exchange/pancakeswap-polygon-zkevm-default.json'
const PANCAKE_ARB_DEFAULT = 'https://tokens.yantra.exchange/pancakeswap-arbitrum-default.json'
...
// export const CMC = 'https://tokens.yantra.exchange/cmc.json' // not updated for a while
