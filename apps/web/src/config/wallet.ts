  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/yantra.exchange/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/yantra.exchange/',
    },
    {
      id: 'binance',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://yantra.exchange/',
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.yantra.exchange/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.yantra.exchange/get-started/wallet-guide`
