...
import MenuActive from '@pancakeswap/uikit/components/Svg/YantraIcons/MenuActive'
...
const LeftMenu = ({ menuItems, activeItem, activeSubItem }) => {
  return (
    <MenuContainer>
      ...
      <SocialLinks>
        <DiscordIcon href="https://discord.gg/Uc5eKY87" target="_blank" cursor="pointer" />
        <TelegramIcon href="https://t.me/YantraExchangePortal" target="_blank" cursor="pointer" />
        <TwitterIcon href="https://twitter.com/YantraExchange" target="_blank" cursor="pointer" />
        <GithubIcon href="https://github.com/yantra-exchange" target="_blank" cursor="pointer" />
