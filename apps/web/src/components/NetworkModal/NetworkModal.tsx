...
import { SUPPORT_ONLY_BLAST } from 'config/constants/supportChains'
...
export const NetworkModal = ({ pageSupportedChains = SUPPORT_ONLY_BLAST }: { pageSupportedChains?: number[] }) => {
  ...
  const isScrollOnlyPage = useMemo(() => {
    return pageSupportedChains?.length === 1 && pageSupportedChains[0] === ChainId.BLAST_TESTNET
  }, [pageSupportedChains])
